            ...
            <form action="{{ route('admin.banner.update', $banner->id) }}"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-tinymce name="content" id="editor" :value="old('content'), $banner->description" />
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="status"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-600
                                           ...
                                           focus:border-emerald-500 focus:ring-emerald-500">
                                <option value="draft"
                                    {{ old('status', $banner->status) === 'draft' ? 'selected' : '' }}>
                                    Draft
                                </option>
                                <option value="published"
                                    {{ old('status', $banner->status) === 'published' ? 'selected' : '' }}>
                                    Published
                                </option>
                            </select>
                        </div>
                        ...
                        <div id="expiredAtWrapper" class="">
                            ...
                            <input type="datetime-local"
                               ...
                               value="{{ old(
                                        'expired_at',
                                        $banner->expired_at ? \Carbon\Carbon::parse($banner->expired_at)->format('Y-m-d\TH:i') : null
                                    ) }}"
